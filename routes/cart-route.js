...
const { viewcart, addcart, updateCartItem, removeCartItem, clearCart, checkout } = require("../controllers/cart-controller");
...
cartRoute.delete('/remove-cart-item/:cartItemId', authMiddleware, removeCartItem);
